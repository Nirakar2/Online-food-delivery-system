<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="${pageContext.request.contextPath}/booking" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100" name="booking">
          <div class="form-row">
          ...
          <div class="text-center"><button type="submit" onclick="myFunction()">Submit</button></div>
        </form>
